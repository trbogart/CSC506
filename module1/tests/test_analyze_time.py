...
def test_analyze_time_log_n():
    ...
    assert ComplexityAnalyzer().analyze_time(op, init_test = init_test, init_op = init_op, num_iterations = 10_000) == 'O(log(N))'
...
def test_analyze_time_n():
    ...
    assert ComplexityAnalyzer().analyze_time(op, init_test = init_test, init_op = init_op, num_iterations = 1_000) == 'O(N)'
...
def test_analyze_time_n_log_n():
    ...
    assert ComplexityAnalyzer().analyze_time(op, init_test = init_test, init_op = init_op, num_iterations = 200) == 'O(N*log(N))'
